...
(function (exports) {
	if (exports.ru === undefined) {
		exports.ru = {
			...
			'mejs.prevText': 'В начало',
			'mejs.nextText': 'В конец',
			'mejs.loopText': 'Повтор вкл/выкл',
			'mejs.fullscreenText': 'Полный экран вкл/выкл',
			'mejs.shuffleText': 'Перемешивание вкл/выкл',
			'mejs.playlistText': 'Плейлист вкл/выкл',
